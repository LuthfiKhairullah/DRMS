                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4" style="text-align:right;">
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target=".modal_download_saw_repair">
                                                Download
                                            </button>
                                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                &nbsp
                                                                <a href="<?php base_url() ?>saw_repair/detail_saw_repair/delete/<?= $sr['id_lhp_saw_repair'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin?')">Hapus</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php endforeach ?>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Tambah Saw Repair</h4>
...
<div class="modal fade modal_download_saw_repair" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Download Saw Repair</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="<?= base_url() ?>saw_repair/download" method="post">
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-2">
...
<script>
    ...
    function filter_month() {
        ...
        window.location.replace('<?= base_url() ?>saw_repair/month/' + bulan);
    }
</script>
<?= $this->endSection(); ?>