            ...
            <div class="row">
                <div class="box bg-transparent">
                    <div class="box-body" style="display:flex">
                        <div class="col-2">
                            <form action="<?=base_url()?>dashboard/line_stop_wet" method="POST">
                                ...
                                <select class="form-select" name="child_filter" id="child_filter" style="border-width: thick;border: wh;font-size: 20px;font-weight: 900;width: 175px;">
                                    ...
                                    <?php for ($i=8; $i <= 9 ; $i++) { ?>
                                        <option value="<?=$i?>" <?= ($child_filter == $i) ? 'selected':''?>>WET <?=($i == 8) ? 'A' : 'B'?></option>
                                    <?php } ?>
                                </select>
                                &nbsp;
                        ...
                        <div class="col-6" style="display:flex; margin-top:35px;">
                            <div class="col-3" style="display:flex;text-align:center;flex-direction: column;align-items: center;flex-wrap: nowrap;justify-content: space-around; margin-left:-70px; margin-top:-65px;">
                                ...
                                <a href="<?=base_url()?>dashboard/line_stop_wet" class="waves-effect waves-light btn btn-rounded btn-warning btn-lg btn-nav">Line Stop</a>
                            </div>
                            <div class="col-3">
                ...
                column: {
                    ...
                    events: {
                        click : function(e) {
                            ...
                            $.ajax({
                                url: '<?= base_url('dashboard/line_stop_wet/get_detail_line_stop') ?>',
                                type: 'POST',
                                data: {
                                    date: date,
                                    line: line
    ...
    <?php } elseif ($baby_filter == 'line') { ?>
        Highcharts.chart('average_daily_chart_by_line', {
            ...
            series: [
                {
                        name: 'Wet A',
                        data: <?php echo json_encode($data_line_stop_line_8); ?>
                    },
                    {
                        name: 'Wet F',
                        data: <?php echo json_encode($data_line_stop_line_9); ?>
                    },
            ],
        ...
        Highcharts.chart('average_month_chart_by_line', {
            ...
            series: [
                {
                    name: 'Wet A',
                    data: <?php echo json_encode($data_line_stop_by_month_line_8); ?>,
                },
                {
                    name: 'Wet F',
                    data: <?php echo json_encode($data_line_stop_by_month_line_9); ?>,
                },
            ]
        });
    <?php    }   ?>
