                    ...
                    <div class="box bg-transparent">
                        <div class="box-body" style="display:flex">
                            ...
                            <div class="col-6" style="display:flex; margin-top:40px;">
                                ...
                                <a href="<?=base_url()?>dashboard/assy/amb2" class="waves-effect waves-light btn btn-rounded btn-success btn-lg btn-nav">Efficiency</a>
...
<script>
    ...
    Highcharts.chart('side_chart', {
        ...
        series: [
            ...
            <?php } else if ($child_filter != null AND $child_filter != '0' AND $child_filter != 0 AND $baby_filter == 'grup') {
